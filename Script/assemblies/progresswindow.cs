...
namespace ProgressWindow
{
    ...
    public class Theme : ThemeBase
    {
        ...
        internal Brush backgroundBrush = new SolidColorBrush(backgroundColor);
        internal Brush foregroundBrush = new SolidColorBrush(Colors.WhiteSmoke);

        internal Brush windowBackgroundBrush = GetFreezedBrush(15, 15, 15);
        internal Brush highlightForegroundBrush = GetFreezedBrush(106, 199, 255);
        internal Brush lowlightForegroundBrush = GetFreezedBrush(200, 200, 200);
        internal Brush lowlightBackgroundBrush = GetFreezedBrush(45, 45, 45);
        internal Brush borderBrush = GetFreezedBrush(80, 80, 80);
        internal Brush mouseOverBackgroundBrush = GetFreezedBrush(255, 255, 255, 35);
        internal Brush pressedBackgroundBrush = GetFreezedBrush(100, 100, 100);
        internal Brush progressBarBgBrush = GetFreezedBrush(10, 10, 10);
        internal Brush progressBarFgBrush = GetFreezedBrush(73, 129, 245);
        internal Brush progressBarStripeBrush = GetFreezedBrush(86, 149, 247);
        internal Brush toggleOnBrush = GetFreezedBrush(90, 200, 255);
        internal Brush warningIconBrush = GetFreezedBrush(238, 157, 40);
        internal Brush progressBarCompletedBrush = GetFreezedBrush(0, 160, 200);
        internal Brush switchEllipseBrush = GetFreezedBrush(220, 220, 220);
        internal Brush switchOnEllipseBrush = GetFreezedBrush(20, 20, 20);
        internal Brush switchBorderBrush = GetFreezedBrush(150, 150, 150);
        internal Brush switchBackgroundBrush = GetFreezedBrush(30, 30, 30);
        internal Brush switchMouseOverBackgroundBrush = GetFreezedBrush(70, 70, 70);
        internal Brush switchOnBackgroundBrush = GetFreezedBrush(0, 120, 220);
        internal Brush switchOnMouseOverBackgroundBrush = GetFreezedBrush(20, 160, 255);
        internal Brush snackbarBackgroundBrush = GetFreezedBrush(80, 80, 80, 220);
        internal Brush spinnerBackgroundBrush = GetFreezedBrush(116, 39, 116);
        internal Brush spinnerForegroundBrush = GetFreezedBrush(184, 127, 183);
        internal Brush completedIconBrush = GetFreezedBrush(98, 255, 223);
        internal Geometry barGeometry = GetGeometry("M 2 0 L 38 0 A 2 2 0 0 1 38 4 L 2 4 A 2 2 0 0 1 2 0 Z");
        internal Geometry pinGeometry = GetGeometry(
        ...
        internal Geometry pinnedGeometry = GetGeometry(
        ...
        internal Geometry minimiseGeometry = GetGeometry(
            "M 0.75 11.25 a 0.75 0.75 90 0 0 0 1.5 l 13.5 0 a 0.75 0.75 90 0 0 0 -1.5 z M 0 15"
        );
        internal Geometry promptGeometry = GetGeometry(
        ...
        internal Geometry suspendGeometry = GetGeometry(
        ...
        internal Geometry resumeGeometry = GetGeometry(
        ...
        internal Geometry cancelGeometry = GetGeometry(
        ...
        internal Geometry tabLeftGeometry = GetGeometry(
            "M 10 0 L 0 0 A 2.5 2.5 90 0 1 2.5 2.5 L 2.5 25.1 A 5.1 5.1 90 0 0 7.4 30 L 10 30"
        );
        internal Geometry tabRightGeometry = GetGeometry(
        ...
537109 2.978516 15.758463 3.02409 15.966797 3.115234 C 16.175129 3.206381 16.357422 3.330078 16.513672 3.486328 C 16.669922 3.642578 16.793619 3.824871 16.884766 4.033203 C 16.97591 4.241537 17.021484 4.462891 17.021484 4.697266 C 17.021484 4.931641 16.97591 5.152995 16.884766 5.361328 C 16.793619 5.569662 16.669922 5.751954 16.513672 5.908203 C 16.357422 6.064454 16.175129 6.188152 15.966797 6.279297 C 15.758463 6.370443 15.537109 6.416016 15.302734 6.416016 C 15.068359 6.416016 14.847005 6.370443 14.638672 6.279297 C 14.430338 6.188152 14.248046 6.064454 14.091797 5.908203 C 13.935546 5.751954 13.811848 5.569662 13.720703 5.361328 C 13.629557 5.152995 13.583984 4.931641 13.583984 4.697266 C 13.583984 4.462891 13.629557 4.241537 13.720703 4.033203 C 13.811848 3.824871 13.935546 3.642578 14.091797 3.486328 C 14.248046 3.330078 14.430338 3.206381 14.638672 3.115234 C 14.847005 3.02409 15.068359 2.978516 15.302734 2.978516 Z "
        );
        internal Geometry oemGeometry = GetGeometry(
        ...
        internal Geometry completedGeometry = GetGeometry(
        ...
        internal Geometry playGeometry = GetGeometry(
        ...
        internal Geometry stopGeometry = GetGeometry(
        ...
        private static readonly Lazy<Theme> lazy =
            new Lazy<Theme>(() => new Theme());

        private Theme() { }

        public static Theme I { get { return lazy.Value; } }
    }
    ...
    public class MainWindow : Window
    {
        ...
        public MainWindow(ProgressViewModel viewModel)
        {
            ...
            Background = Theme.I.windowBackgroundBrush;
    ...
    public class CustomTabControl : TabControl
    {
        ...
        {
            Background = Theme.I.backgroundBrush;
            Style = CreateStyle();
            InitializeComponent();
        }
        ...
        private void InitializeComponent()
        {
            ...
            {
                FontFamily = Theme.I.MonospaceFontFamily,
                GridRow = 3
            };

            var operationText = new CustomTextBlock("CurrentOperation")
            {
                FontFamily = Theme.I.HeadingFontFamily, //new FontFamily("Yu Gothic UI Semibold"),
                Foreground = Theme.I.highlightForegroundBrush,
                GridRow = 0
            };
            ...
            {
                FontFamily = Theme.I.MainFontFamily, //new FontFamily("Verdana"),
                FontSize = 13,
                GridRow = 2
            };
            ...
            progressGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(37) });
            progressGrid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto });
            progressGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(18) });
            ...
            var progressTab = new CustomTabItem
            {
                ...
                {
                    Data = Theme.I.progressGeometry,
                    Fill = Theme.I.highlightForegroundBrush,
                    Stroke = Theme.I.highlightForegroundBrush,
                    Margin = new Thickness(6, 0, 4, 0)
                },
                Content = progressGrid,
            };

            var cpuLimitSlider = new Slider
            {
                Minimum = 1.0,
                Maximum = 9.0,
                Width = 330.0,
            ...
            var cpuLimitBinding = new Binding("CpuRateLimit")
            {
                Mode = BindingMode.TwoWay,
                UpdateSourceTrigger = UpdateSourceTrigger.PropertyChanged,
                Delay = 100,
            };
            cpuLimitSlider.SetBinding(Slider.ValueProperty, cpuLimitBinding);
            Grid.SetRow(cpuLimitSlider, 1);
            Grid.SetColumn(cpuLimitSlider, 1);

            var cpuLimitLabel = new CustomTextBlock("CpuRateLimit", "Weight : {0:0}")
            {
                FontSize = 14.5,
                GridRow = 1,
                GridColumn = 2,
            ...
            var cpuRateControlGrid = new Grid();
            cpuRateControlGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(1.0, GridUnitType.Star) });
            cpuRateControlGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
            cpuRateControlGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
            cpuRateControlGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(1.0, GridUnitType.Star) });
            cpuRateControlGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1.0, GridUnitType.Star) });
            cpuRateControlGrid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto });
            cpuRateControlGrid.RowDefinitions.Add(new RowDefinition { Height = GridLength.Auto });
            cpuRateControlGrid.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1.0, GridUnitType.Star) });

            cpuRateControlGrid.Children.Add(cpuLimitSlider);
            cpuRateControlGrid.Children.Add(cpuLimitLabel);

            var CpuRateControlTab = new CustomTabItem
            {
                Header = "CPU",
                Icon = new System.Windows.Shapes.Path
                {
                    Data = Theme.I.oemGeometry,
                    Fill = Theme.I.highlightForegroundBrush,
                    Margin = new Thickness(10, 0, 4, 0)
                },
                Content = cpuRateControlGrid
            };
    ...
    public class CustomTabItem : TabItem
    {
        ...
        private static Style CreateStyle()
        {
            ...
            tabLeft.SetValue(System.Windows.Shapes.Path.DataProperty, Theme.I.tabLeftGeometry);
            ...
            tabRight.SetValue(System.Windows.Shapes.Path.DataProperty, Theme.I.tabRightGeometry);
            ...
            isSelectedTrigger.Setters.Add(new Setter(Control.ForegroundProperty, Theme.I.foregroundBrush));
            isSelectedTrigger.Setters.Add(new Setter(Control.BackgroundProperty, Theme.I.backgroundBrush));
            ...
            mouseOverTrigger.Setters.Add(new Setter(Control.BackgroundProperty, Theme.I.lowlightBackgroundBrush));
            ...
            style.Setters.Add(new Setter(Control.ForegroundProperty, Theme.I.lowlightForegroundBrush));
            return style;
        }
    }
    ...
    public class CustomFooter : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Data = Theme.I.promptGeometry,
                Fill = Theme.I.foregroundBrush,
            ...
            */
            ...
            {
                Data = Theme.I.openfolderGeometry,
                Fill = Theme.I.foregroundBrush,
                Margin = new Thickness { Left = 5, Right = 5 },
                VerticalAlignment = VerticalAlignment.Center
            });
            ...
            {
                Data = Theme.I.cancelGeometry,
                Fill = Theme.I.warningIconBrush,
                Margin = new Thickness { Left = 10, Right = 10 },
                VerticalAlignment = VerticalAlignment.Center
            });
    ...
    public class CustomHeader : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Text = "FFMPEG",
                Foreground = Theme.I.AccentColorBrush,
                FontFamily = Theme.I.LogoFontFamily, //new FontFamily("Impact"),
            ...
            {
                Data = Theme.I.barGeometry,
                Fill = Theme.I.AccentColorBrush,
                Stroke = Theme.I.AccentColorBrush,
            ...
            var pinButton = new CustomToggleButton(
                new System.Windows.Shapes.Path
                {
                    Data = Theme.I.pinGeometry,
                    Fill = Theme.I.foregroundBrush,
                },
                new System.Windows.Shapes.Path
                {
                    Data = Theme.I.pinnedGeometry,
                    Fill = Theme.I.toggleOnBrush
                }
            )
            {
    ...
    class TileButton : ButtonBase
    {
        ...
        protected TileButton()
        {
            ...
            Foreground = Theme.I.foregroundBrush;
            Background = Brushes.Transparent;
            FontFamily = Theme.I.IconFontFamily;//new FontFamily("Segoe MDL2 Assets");
            FontSize = 17.0;
            Cursor = Cursors.Hand;
        ...
        protected static ControlTemplate CreateTemplate()
        {
            ...
            mouseOverTrigger.Setters.Add(new Setter(Border.BackgroundProperty, Theme.I.mouseOverBackgroundBrush, "border"));
            ct.Triggers.Add(mouseOverTrigger);
            ...
            pressedTrigger.Setters.Add(new Setter(Border.BackgroundProperty, Theme.I.pressedBackgroundBrush, "border"));
    ...
    public class Snackbar : HeaderedContentControl
    {
        ...
        public Snackbar()
        {
            ...
            Background = Theme.I.snackbarBackgroundBrush;
    ...
    public class LoadingMessage : Snackbar
    {
        public LoadingMessage()
        {
            ...
            Header = header;
            var text = new CustomTextBlock("BusyMessage")
            {
                FontFamily = SystemFonts.MessageFontFamily,
                Margin = new Thickness { Left = 5, Right = 20 }
            };
            text.Typography.SlashedZero = false;
            Content = text;
        }
    }
    ...
    public class CompleteMessage : Snackbar
    {
        public CompleteMessage()
        {
            ...
            {
                Data = Theme.I.completedGeometry,
                Fill = Theme.I.completedIconBrush,
                Width = 25,
                Height = 25,
                Stretch = Stretch.Uniform
            };
    ...
    public class CustomSpinner : UserControl
    {
        ...
        private void InitializeComponent()
        {
            var circle = new System.Windows.Shapes.Path
            {
                ...
                Fill = Theme.I.spinnerBackgroundBrush,
            ...
            ArcLeft = new System.Windows.Shapes.Path
            {
                ...
                Fill = Theme.I.spinnerForegroundBrush,
                UseLayoutRounding = false,
            };
    ...
    public class ProgressViewModel : ViewModelBase
    {
        ...
        private double _cpuRateLimit = 5.0;
        public double CpuRateLimit
        {
            get { return _cpuRateLimit; }
            set
            {
                if (SetProperty(ref _cpuRateLimit, value))
                {
                    CpuLimitChangeCommand.Execute(value);
                }
            }
        }
        ...
        private ICommand _cpuLimitChangeCommand;
        public ICommand CpuLimitChangeCommand
        {
            get { return _cpuLimitChangeCommand; }
            set { SetProperty(ref _cpuLimitChangeCommand, value); }
        }
